            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/logo tut wuri handayani.png') ?>" alt="" class="img-fluid" width="100px">
                    </a>
                    <h3>E-Absensi SMK BUSTANUL ULUM</h3>
                </div>
                <ul class="nav">
                    <li class="nav-item">
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2021 <a href="">SMK FULL DAY BUSTANUL ULUM</a>
                        </p>
                    </nav>
                </div>
            </footer>
