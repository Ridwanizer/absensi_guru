                    ...
                    <section id="login-body" class="pt-3">
                        <div class="card border-0 shadow pt-3">
                            <div class="card-header bg-transparent border-bottom-0 pb-0 text-center">
                                <img src="<?= base_url('assets/img/logo tut wuri handayani.png') ?>" alt="Logo Indoexpress" class="img-fluid mx-auto d-block" width ="80px">
                                <div class="mt-3">
                                    <h4 class="card-info text-center">SMK FULL DAY BUSTANUL ULUM</h4>
                                </div>
                            </div>
                            <div class="card-body">
